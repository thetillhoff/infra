module "k8s" {
  ...
  nodegroups = {
    "talos-v1-10-3-arm64-controlplane" = {
      count              = 2
      talos_image_id     = "240979498" # Retrieved from packer snapshot id
  ...
  retrieve_talosconfig_from_nodegroup = "talos-v1-10-3-arm64-controlplane"
