...
const versions = {
  kubernetes: "v1.35.3", // From https://kubernetes.io/releases/
  ...
  fluxOperator: "0.46.0", // From https://github.com/controlplaneio-fluxcd/flux-operator/releases
  flux: "v2.8.5", // From https://github.com/fluxcd/flux2/releases
};
